...
void SPH_UIControl::Init(ID3D11Device * pd3dDevice,ID3D11DeviceContext * m_pd3dDevContext,SPHSystem & sph_system,MarchingCube & sph_marchingcube)//
{
	...
	// Add UI
	/*CEGUI::Window* updateEventLabel = winMgr.createWindow("TaharezLook/Label","Label");
	// horizontalLayout->addChild(updateEventLabel);
	updateEventLabel->setPosition(CEGUI::UVector2(cegui_reldim(0.1f), cegui_reldim( 0.1f)));
	...
	g_droot->addChild(updateEventLabel);


	//Button
	CEGUI::ButtonBase* button = static_cast<CEGUI::ButtonBase *>(winMgr.createWindow("TaharezLook/Button", "Button"));
	button->setPosition(CEGUI::UVector2(cegui_reldim(0.2f), cegui_reldim( 0.2f)));
	button->setSize(CEGUI::USize(cegui_reldim(0.25f), cegui_reldim(0.04f)));
	button->setText("Button");
	g_droot->addChild(button);
	button->subscribeEvent(CEGUI::ButtonBase::EventMouseClick,CEGUI::Event::Subscriber(Handlebuttonclicked));

	CEGUI::Editbox* editbox = static_cast<CEGUI::Editbox*>(winMgr.createWindow("Vanilla/Editbox", "EditBox"));
	...
	m_pSPHPanel->setPosition(CEGUI::UVector2(cegui_reldim(0.02), cegui_reldim(0.02)));
	m_pSPHPanel->setSize(CEGUI::USize(cegui_reldim(0.97f), cegui_reldim( 0.9)));
	...
	CEGUI::Window* Label;
// 	CEGUI::Window* Label = winMgr.createWindow("TaharezLook/Label","Label");
// 	// horizontalLayout->addChild(updateEventLabel);
// 	Label->setPosition(CEGUI::UVector2(cegui_reldim(0.05), cegui_reldim( 0.05f)));
// 	Label->setSize(CEGUI::USize(cegui_reldim(0.25), cegui_reldim(0.05)));
// 	Label->setText("Particle Number");
// 	// updateEventLabel->setFont("DejaVuSans-12-NoScale");
...
// 
// 	CEGUI::Editbox* editbox = static_cast<CEGUI::Editbox*>(winMgr.createWindow("Vanilla/Editbox", "EditBox"));
// 	editbox->setPosition(CEGUI::UVector2(cegui_reldim(0.05), cegui_reldim( 0.10)));
// 	editbox->setSize(CEGUI::USize(cegui_reldim(0.25), cegui_reldim(0.05)));
// 	editbox->setText("");
// 	editbox->setReadOnly(false);
// 	st->addChild(editbox);
...
// 	float m_gasConstantK;
	...
	EditBoxText[0] = CEGUI::PropertyHelper<float>::toString(m_pSPHSystem->m_iParticleCount);
...
// 
// 	Label = winMgr.createWindow("TaharezLook/Label","MarchingCubeLabel");
// 	Label->setPosition(CEGUI::UVector2(cegui_reldim(0), cegui_reldim( 0.63)));
// 	Label->setSize(CEGUI::USize(cegui_reldim(0.4), cegui_reldim(0.03)));
// 	Label->setText("Marching Cube");
// 	//Label->setFont("DejaVuSans-14-NoScale");
// 	Label->setProperty("HorzFormatting", "LeftAligned");
// 
// 	st->addChild(Label);
	...
	for(int i = 0;i < 4;i++)
		for(int m = 0; m < 3; m++)
		{
			if(i < 3)
			{
				...
				Label->setPosition(CEGUI::UVector2(cegui_reldim(0.05 + m * 0.34), cegui_reldim( 0.085f + i * 0.165)));
				Label->setSize(CEGUI::USize(cegui_reldim(0.4), cegui_reldim(0.065)));
				...
				editbox->setPosition(CEGUI::UVector2(cegui_reldim(0.05 + m * 0.34), cegui_reldim( 0.16 + i * 0.165)));
				editbox->setSize(CEGUI::USize(cegui_reldim(0.25), cegui_reldim(0.063)));
			...
			{
				Label = winMgr.createWindow("TaharezLook/Label", LabelName[i * 3 + m]);
				Label->setPosition(CEGUI::UVector2(cegui_reldim(0.05 + m * 0.5), cegui_reldim( 0.085f + i * 0.165)));
				Label->setSize(CEGUI::USize(cegui_reldim(0.48), cegui_reldim(0.07)));
				Label->setText(LabelText[i * 3 + m]);
				// updateEventLabel->setFont("DejaVuSans-12-NoScale");
				Label->setProperty("HorzFormatting", "LeftAligned");
				m_pSPHPanel->addChild(Label);
				...
				editbox = static_cast<CEGUI::Editbox*>(winMgr.createWindow("TaharezLook/Editbox", EditBoxName[i * 3 + m]));
				editbox->setPosition(CEGUI::UVector2(cegui_reldim(0.05 + m * 0.5), cegui_reldim( 0.16 + i * 0.165)));
				editbox->setSize(CEGUI::USize(cegui_reldim(0.25), cegui_reldim(0.063)));
				editbox->setText(EditBoxText[i * 3 + m]);
				editbox->setReadOnly(false);
				editbox->setValidationString("^(\\d+[.]?)?\\d*$");
			...
			{
				Label = winMgr.createWindow("TaharezLook/Label", LabelName[i * 3 + m]);
				Label->setPosition(CEGUI::UVector2(cegui_reldim(0.05 ), cegui_reldim( 0.25f + i * 0.165)));
				Label->setSize(CEGUI::USize(cegui_reldim(0.48), cegui_reldim(0.07)));
				Label->setText(LabelText[i * 3 + m]);
				// updateEventLabel->setFont("DejaVuSans-12-NoScale");
				Label->setProperty("HorzFormatting", "LeftAligned");
				...
				editbox = static_cast<CEGUI::Editbox*>(winMgr.createWindow("TaharezLook/Editbox", EditBoxName[i * 3 + m]));
				editbox->setPosition(CEGUI::UVector2(cegui_reldim(0.05 ), cegui_reldim( 0.335 + i * 0.165)));
				editbox->setSize(CEGUI::USize(cegui_reldim(0.25), cegui_reldim(0.063)));
				editbox->setText(EditBoxText[i * 3 + m]);
				editbox->setReadOnly(false);
				editbox->setValidationString("^(\\d+[.]?)?\\d*$");
	...
	/*	CEGUI::Window* ButtonPanel = winMgr.createWindow("TaharezLook/StaticText", "ButtonPanel");
		ButtonPanel->setPosition(CEGUI::UVector2(cegui_reldim(0), cegui_reldim(0.63)));
		ButtonPanel->setSize(CEGUI::USize(cegui_reldim(0.98f), cegui_reldim( 0.32)));
		ButtonPanel->setText("SPH Variable");
		ButtonPanel->setProperty("VertFormatting", "TopAligned");
		fwnd->addChild(ButtonPanel);

		CEGUI::ButtonBase* button = static_cast<CEGUI::ButtonBase *>(winMgr.createWindow("TaharezLook/Button", "ResetButton"));
		button->setPosition(CEGUI::UVector2(cegui_reldim(0.05f), cegui_reldim( 0.25f)));
		button->setSize(CEGUI::USize(cegui_reldim(0.4f), cegui_reldim(0.15f)));
		button->setText("Reset");
		ButtonPanel->addChild(button);
		button->subscribeEvent(CEGUI::ButtonBase::EventMouseClick,CEGUI::Event::Subscriber(Handlebuttonclicked));

		button = static_cast<CEGUI::ButtonBase *>(winMgr.createWindow("TaharezLook/Button", "DefaultButton"));
		button->setPosition(CEGUI::UVector2(cegui_reldim(0.5f), cegui_reldim( 0.25f)));
		button->setSize(CEGUI::USize(cegui_reldim(0.4f), cegui_reldim(0.15f)));
		...
		fwndright->setPosition(CEGUI::UVector2(cegui_reldim(0.75), cegui_reldim( 0.31)));
		fwndright->setMaxSize(CEGUI::USize(cegui_reldim(1.0f), cegui_reldim( 1.0f)));
		fwndright->setSize(CEGUI::USize(cegui_reldim(0.25f), cegui_reldim( 0.3)));
		...
		MarchingCubePanel->setPosition(CEGUI::UVector2(cegui_reldim(0.02), cegui_reldim(0.02)));
		MarchingCubePanel->setSize(CEGUI::USize(cegui_reldim(0.97f), cegui_reldim( 0.83)));
		...
		for(int i = 0;i < 3; i++)
		{
			...
			Label->setPosition(CEGUI::UVector2(cegui_reldim(0.05 + i * 0.34), cegui_reldim( 0.15)));
			Label->setSize(CEGUI::USize(cegui_reldim(0.4), cegui_reldim(0.2)));
			...
			editbox->setPosition(CEGUI::UVector2(cegui_reldim(0.05 + i * 0.34), cegui_reldim( 0.4)));
			editbox->setSize(CEGUI::USize(cegui_reldim(0.25), cegui_reldim(0.2)));
		...
		fwndrightdown->setSize(CEGUI::USize(cegui_reldim(0.25f), cegui_reldim( 0.3)));
		...
		ControlPanel->setPosition(CEGUI::UVector2(cegui_reldim(0.02), cegui_reldim(0.02)));
		ControlPanel->setSize(CEGUI::USize(cegui_reldim(0.97f), cegui_reldim( 0.83)));
		...
		Label->setPosition(CEGUI::UVector2(cegui_reldim(0.75 ), cegui_reldim( 0)));
		Label->setSize(CEGUI::USize(cegui_reldim(0.28), cegui_reldim(0.2)));
		Label->setText("0");
		Label->setProperty("HorzFormatting", "LeftAligned");
		ControlPanel->addChild(Label);

		Label = winMgr.createWindow("TaharezLook/Label","RenderModeLabel");
		Label->setPosition(CEGUI::UVector2(cegui_reldim(0.03 ), cegui_reldim(0.47)));
		Label->setSize(CEGUI::USize(cegui_reldim(0.3), cegui_reldim(0.08)));
...
// 		Label = winMgr.createWindow("TaharezLook/Label","Key Input Tips");
// 		Label->setPosition(CEGUI::UVector2(cegui_reldim(0.02 ), cegui_reldim(0.45)));
// 		Label->setSize(CEGUI::USize(cegui_reldim(0.2), cegui_reldim(0.25)));
// 		Label->setText("Render Mode:\nV: Render \nB: Particle\nN: BillBoard \nM: MarchingCube");
// 		Label->setProperty("HorzFormatting", "LeftAligned");
...
void SPH_UIControl::Update(float framecount)
{
	CEGUI::Window * Label = (CEGUI::Window *)ControlPanel->getChild("FrameCount");
	CEGUI::String sframe = CEGUI::PropertyHelper<float>::toString(framecount);
...
void SPH_UIControl::ReturnToDefault()
{
	...
	m_pMarchingCube->returnToDefault();
...
{
// 	EditBoxText[0] = CEGUI::PropertyHelper<float>::toString(m_pSPHSystem.m_iParticleCount);
// 	EditBoxText[1] = CEGUI::PropertyHelper<float>::toString(WallLength);
// 	EditBoxText[2] = CEGUI::PropertyHelper<float>::toString(SPHUnitScale);
// 	EditBoxText[3] = CEGUI::PropertyHelper<float>::toString(sph_system.PointMass());
// 	EditBoxText[4] = CEGUI::PropertyHelper<float>::toString(sph_system.SmoothRadius());
// 	EditBoxText[5] = CEGUI::PropertyHelper<float>::toString(sph_system.Viscosity());
// 	EditBoxText[6] = CEGUI::PropertyHelper<float>::toString(sph_system.RestDensity());
// 	EditBoxText[7] = CEGUI::PropertyHelper<float>::toString(sph_system.GasConstantK());
// 	EditBoxText[8] = CEGUI::PropertyHelper<float>::toString(sph_system.Gravity());
// 	EditBoxText[9] = CEGUI::PropertyHelper<float>::toString(sph_system.BoundaryDampening());
// 	EditBoxText[10] = CEGUI::PropertyHelper<float>::toString(sph_system.BoundaryCoefficient());
// 	EditBoxText[11] = CEGUI::PropertyHelper<float>::toString(DefalutCubeSize);
// 	EditBoxText[12] = CEGUI::PropertyHelper<float>::toString(cuberange);
// 	EditBoxText[13] = CEGUI::PropertyHelper<float>::toString(thresholdvalue);
// 
// 
// 	CEGUI::String EditBoxName[14] = {
// 		"Particle N_Editbox","WallLength_Editbox","UnitScale_Editbox",
// 		"Point_Mass_Editbox","SmoothRadius_Editbox","Viscosity_Editbox",
// 		"RestDensity_Editbox","GasConstantK_Editbox","Gravity_Editbox",
// 		"BoundaryDampening_Editbox","BoundaryCoe_Editbox",
// 		"CubeSize_Editbox","CubeRange_Editbox","IsoValue_Editbox"
// 	};
...
//   	char backup[3][50];
// 	for(int i = 0; i < 3; i++)
//   	strcpy(backup[i],boxname);

	
// 	strcat(cstarterror,boxname);
// 	strcat(enderror,boxname);

	if(str.empty())
	{
		strcat(emptyerror,boxname);
